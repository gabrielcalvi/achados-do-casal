...
export default async function MonitorSmokeFinalPage() {
  ...
  console.log("[MONITOR SMOKE FINAL] Iniciando teste de 1 produto...");
  const resultado = await monitorarProdutosAutomaticamente(1);
  console.log("[MONITOR SMOKE FINAL] Resultado:", JSON.stringify(resultado));
