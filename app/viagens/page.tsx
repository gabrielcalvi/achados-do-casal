        ...
        <div className="mx-auto flex max-w-7xl items-center gap-4 px-4 py-3 sm:px-5">
          ...
          <nav className="ml-auto flex gap-2 overflow-x-auto pb-1">
            ...
            <a
              ...
              className="shrink-0 rounded-xl bg-green-600 px-4 py-2.5 text-sm font-black text-white transition hover:bg-green-700"
            >
              WhatsApp Viagens
            </a>
            <a
          ...
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="rounded-xl bg-green-500 px-6 py-4 font-black text-white transition hover:bg-green-600"
              >
                💬 Entrar no grupo de Viagens
              </a>
              <a
                href="#nossas-viagens"
