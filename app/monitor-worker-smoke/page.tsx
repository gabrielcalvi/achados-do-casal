...
export default async function MonitorWorkerSmokePage() {
  ...
  console.log("[MONITOR WORKER SMOKE] Iniciando teste de 1 produto...");
  const resultado = await monitorarProdutosAutomaticamente(1);
  console.log("[MONITOR WORKER SMOKE] Resultado:", JSON.stringify(resultado));
